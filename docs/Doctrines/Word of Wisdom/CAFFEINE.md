...
Right, so... The title of this study has two red flags right from the start. 

First, dear reader, you should know what a *case study* is ([1](https://en.wikipedia.org/wiki/Case_report), [2](https://pmc.ncbi.nlm.nih.gov/articles/PMC5686928/), [3](https://research.chm.msu.edu/students-and-residents/writing-a-case-report)). While [anecdotal evidence](https://en.wikipedia.org/wiki/Anecdotal_evidence) is not entirely worthless, its sampling is too small to convey more meaning than "huh, look at that." Speaking of, the second red flag that I see is that the sample size is *two*. ***Two***.

It's been several years since I had to prepare an argumentative paper using authoritative citations, but I feel pretty confident that if I tried to make a point by citing two case reports, that would count heavily against a passing grade. No, it's not entirely worthless information, and should some folks feel motivated to find out more about the lethal dosage of caffeine, these two case reports would be their baseline reference point.
