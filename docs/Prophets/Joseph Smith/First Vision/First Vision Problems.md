...
---
# 🚩 Problems
This page of notes will make more sense if you've already read my notes on the [[First Vision]] generally. There it outlines four accounts of the event and describes some discrepancies. Here, we'll examine those problems in greater depth.
...
Now... are you *really* sure you were praying to know if the Book of Mormon was true in that memory? Are you sure you weren't just praying for forgiveness, and *then* felt that the book was true? Hadn't you actually concluded that there was no "true" religious texts, so you were asking God what to do?
...
Nope. Doesn't even mention in passing that Joseph had anything like a First Vision. Would be a prime opportunity to demonstrate the prophet's experience in 1820 of seeking mercy and receiving forgiveness, and maybe something about truth. Would also be a good time to demonstrate that God has a physical body and is actively participating in ensuring we have a shot at salvation by physically appearing to call a prophet. None of that appears, but instead we get a conflicting description of God's corporeal nature.
