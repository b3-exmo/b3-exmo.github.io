...
## Notes
Quick observation: the term "saith the Lord" appears 23 times in this section. Out of 66 verses, 34% of them need to remind us of who's talking... You know, in case [[True#Maxim of Quantity|that wasn't evident]] by the pretext of this document being revelatory. Readers need to be reminded that this is definitely not just [[Joseph Smith]] rationalizing his extramarital affairs, nope, this is definitely God talking.
...
Why would we dress it up and call it the new and everlasting covenant if it wasn’t a code term? There’s already a word for it. Marriage. English grammar allows us to put a qualifying adjective before it; Eternal Marriage is self-explanatory enough that it doesn’t need a code phrase, because Plural Marriage (as explicitly stated in the section header; also self-explanatory) just doesn’t sound so innocuous.
...
... This *is* just plain ol' regular marriage, right? Why would God reveal such strong wording to the prophet Joseph Smith if this was something we're all already on board with doing?
